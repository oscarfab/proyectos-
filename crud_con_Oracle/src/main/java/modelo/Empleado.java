...
@Data
@Entity
@Table(name = "EMPLEADOS")  // ← Oracle usa mayúsculas por defecto
@Schema(description = "Entidad que representa un empleado en el sistema")
public class Empleado {

    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "empleado_seq")  // ← CAMBIADO
    @SequenceGenerator(name = "empleado_seq", sequenceName = "EMPLEADO_SEQ", allocationSize = 1)  // ← NUEVO
    ...
    @Column(name = "AREA", length = 50)  // ← Mayúsculas
    ...
    @Column(name = "CORREO_ELECTRONICO", length = 100)  // ← Mayúsculas
